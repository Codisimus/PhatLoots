...
public class MythicDropsItem extends Loot {
    ...
    private static class AddMythicDropsItemButton extends Button {
        ...
        public boolean onClick(Inventory inv, PhatLoot phatLoot, List<Loot> lootList) {
            ...
            lootList.add(new MythicDropsItem(tierList.get(0)));
            return true;
        }
    }
    ...
    public static void registerButtonAndTool() {
        ...
        meta.setDisplayName("§2MythicDrops Tier Toggle (Click to change Tool)");
        lore.add("§1Tiers toggle in alphabetical order");
        lore.add("§4LEFT CLICK:");
        lore.add("§6 Next Tier");
        lore.add("§4RIGHT CLICK:");
        lore.add("§6 Previous Tier");
        lore.add("§4DOUBLE CLICK:");
        lore.add("§6 Ahead 10 Tiers");
        lore.add("§4SHIFT + LEFT CLICK:");
        lore.add("§6 Ahead 100 Tiers");
        lore.add("§4SHIFT + RIGHT CLICK:");
        lore.add("§6 Back 100 Tiers");
        lore.add("§4SCROLL CLICK:");
        lore.add("§6 Back to first Tier");
        meta.setLore(lore);
